...
TEST_CASES = [
    ...
    QueryCase(
        name="Bagerhat district selection shows branch details directly",
    ...
    QueryCase(
        name="Barishal district selection shows branch details directly",
        messages=["Locate Us", "Barishal"],
        sources={"branch-locator-agent"},
        must_contain=[
            "EBL Barishal branches matching Barishal",
            "Barishal Branch",
            "Routing No.",
            "https://www.ebl.com.bd/branches",
        ],
    ...
    QueryCase(
        name="Bogura district selection shows branch details directly",
        messages=["Locate Us", "Bogura"],
        sources={"branch-locator-agent"},
        must_contain=[
            "EBL Bogura branches matching Bogura",
            "Bogura Branch",
            "Routing No.",
            "https://www.ebl.com.bd/branches",
        ],
    ...
    QueryCase(
        name="Brahmanbaria district selection shows branch details directly",
        messages=["Locate Us", "Brahmanbaria"],
        sources={"branch-locator-agent"},
        must_contain=[
            "EBL Brahmanbaria branches matching Brahmanbaria",
            "Brahmanbaria Branch",
            "Routing No.",
            "https://www.ebl.com.bd/branches",
        ],
    ...
    QueryCase(
        ...
        quick_actions_contain=["Gulshan", "Mirpur", "Dhanmondi"],
    ),
    QueryCase(
        ...
        quick_actions_contain=["Agrabad", "Jubilee Road", "O.R. Nizam Road"],
    ),
    QueryCase(
        name="Coxs Bazar district selection shows branch details directly",
        messages=["Locate Us", "Coxs Bazar"],
        sources={"branch-locator-agent"},
        must_contain=[
            "EBL Cox's Bazar branches matching Cox's Bazar",
            "Cox's Bazar Branch",
            "Routing No.",
            "https://www.ebl.com.bd/branches",
        ],
    ...
    QueryCase(
        name="Cumilla district selection shows branch details directly",
        messages=["Locate Us", "Cumilla"],
        sources={"branch-locator-agent"},
        must_contain=[
            "EBL Cumilla branches matching Cumilla SME-AGRI",
            "Cumilla SME-AGRI Branch",
            "Routing No.",
            "https://www.ebl.com.bd/branches",
        ],
    ),
    QueryCase(
        name="Faridpur district selection shows branch details directly",
        messages=["Locate Us", "Faridpur"],
        sources={"branch-locator-agent"},
        must_contain=[
            "EBL Faridpur branches matching Faridpur",
            "Faridpur Branch",
            "Routing No.",
            "https://www.ebl.com.bd/branches",
        ],
    ...
    QueryCase(
        name="Feni district selection shows branch details directly",
        messages=["Locate Us", "Feni"],
        sources={"branch-locator-agent"},
        must_contain=[
            "EBL Feni branches matching Feni SME-AGRI",
    ...
    QueryCase(
        ...
        quick_actions_contain=["Board Bazar", "Mawna", "Mouchak"],
    ),
    QueryCase(
        name="Jashore district selection shows branch details directly",
        messages=["Locate Us", "Jashore"],
        sources={"branch-locator-agent"},
        must_contain=[
            "EBL Jashore branches matching Jashore",
            "Jashore Branch",
            "Routing No.",
            "https://www.ebl.com.bd/branches",
        ],
    ...
    QueryCase(
        name="Kishoreganj district selection shows branch details directly",
        messages=["Locate Us", "Kishoreganj"],
        sources={"branch-locator-agent"},
        must_contain=[
            "EBL Kishoreganj branches matching Bhairab SME",
            "Bhairab SME",
            "Routing No.",
            "https://www.ebl.com.bd/branches",
        ],
    ...
    QueryCase(
        ...
        quick_actions_contain=["Fulbarigate", "Khulna"],
    ),
    QueryCase(
        name="Moulvibazar district selection shows branch details directly",
        messages=["Locate Us", "Moulvibazar"],
        sources={"branch-locator-agent"},
        must_contain=[
            "EBL Moulvibazar branches matching Moulvibazar",
            "Moulvibazar Branch",
            "Routing No.",
            "https://www.ebl.com.bd/branches",
        ],
    ...
    QueryCase(
        name="Mymensingh district selection shows branch details directly",
        messages=["Locate Us", "Mymensingh"],
        sources={"branch-locator-agent"},
        must_contain=[
            "EBL Mymensingh branches matching Mymensingh SME-AGRI",
    ...
    QueryCase(
        ...
        quick_actions_contain=["Bhulta", "Narayangonj", "Sonargaon"],
    ),
    QueryCase(
        name="Narsingdi district selection shows branch details directly",
        messages=["Locate Us", "Narsingdi"],
        sources={"branch-locator-agent"},
        must_contain=[
            "EBL Narsingdi branches matching Madhabdi SME",
            "Madhabdi SME",
            "Routing No.",
            "https://www.ebl.com.bd/branches",
        ],
    ...
    QueryCase(
        ...
        quick_actions_contain=["Chowmuhani", "Maijdee"],
    ),
    QueryCase(
        name="Rajshahi district selection shows branch details directly",
        messages=["Locate Us", "Rajshahi"],
        sources={"branch-locator-agent"},
        must_contain=[
            "EBL Rajshahi branches matching Rajshahi",
            "Rajshahi Branch",
            "Routing No.",
            "https://www.ebl.com.bd/branches",
        ],
    ...
    QueryCase(
        name="Rangpur district selection shows branch details directly",
        messages=["Locate Us", "Rangpur"],
        sources={"branch-locator-agent"},
        must_contain=[
            "EBL Rangpur branches matching Rangpur",
            "Rangpur Branch",
            "Routing No.",
            "https://www.ebl.com.bd/branches",
        ],
    ...
    QueryCase(
        ...
        quick_actions_contain=["Chouhatta", "Fenchuganj", "Upashahar"],
    ),
    QueryCase(
        name="Locate Us back from area suggestions returns district menu",
        messages=["Locate Us", "Dhaka", "Back"],
        sources={"branch-locator-agent"},
        must_contain=["Which district branch do you want to locate?"],
        quick_actions_contain=["Dhaka", "Chattogram", "Sylhet"],
        quick_actions_not_contain=["Gulshan", "Mirpur", "Dhanmondi"],
    ),
    QueryCase(
        name="Tangail district selection shows branch details directly",
        messages=["Locate Us", "Tangail"],
        sources={"branch-locator-agent"},
        must_contain=[
            "EBL Tangail branches matching Tangail",
            "Tangail Branch",
            "Routing No.",
            "https://www.ebl.com.bd/branches",
        ],
